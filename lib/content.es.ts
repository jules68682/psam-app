...
// Traduction ESPAGNOLE générée par scripts/translate-content.ts à partir de lib/content.ts.
...
// Généré le 2026-06-01T08:56:49.027Z.
...
export const teamMembers: TeamMember[] = [
  {
    ...
    "bio": "Chirurgien de la main et du poignet depuis plus de 20 ans. Fondateur de l'Unité Santé Main Aquitaine et spécialisé dans l'artrosis et la rizartrosis.",
    "image": "/images/equipe/joel-rezzouk.JPG",
    "quote": "Parce que trop de patients se sentent démunis face à l'artrosis de la mano. PSAM, c'est un engagement : informer, expliquer et donner à chacun des solutions pour ralentir la maladie. Parce que mieux comprendre, c'est déjà mieux vivre !",
  ...
  },
  {
    ...
    "bio": "Nutritionniste spécialisée en nutrition anti-artrosis et hypnothérapeute. Elle anime des ateliers Nutri artrosis pour aider chacun à adapter son alimentation et mieux vivre avec l'artrosis.",
    "image": "/images/equipe/corinne-moulet.JPG",
    "quote": "Ce que vous mettez dans votre assiette joue un rôle clé ! Certains aliments favorisent l'inflammation, d'autres la réduisent. Mieux manger, c'est aider vos articulacións à mieux vieillir.",
    "isFounder": true
  },
  {
...
export const experts: Expert[] = [
  ...
  },
  {
    ...
    "name": "Valérie MADERT",
    "initials": "VM",
    "role": "terapeuta ocupacional, Orthésiste",
  ...
  },
  {
    ...
    "initials": "RB",
    "role": "fisioterapeuta de la Main"
  },
  {
    "id": "michel-boutan",
    "name": "Michel BOUTAN",
...
export const poles: Pole[] = [
  {
    ...
    "title": "Terapia ocupacional, órtesis, materiales y cuidados calmantes",
    "shortTitle": "T. ocupacional y órtesis",
    "description": "Órtesis a medida, ejercicios protectores, materiales adaptados y gestos cotidianos para aliviar la artrosis de la mano.",
    "icon": "Hand",
  ...
  },
  {
    "id": "hypnose",
    "slug": "hypnose",
    "title": "Hipnosis preparatoria y analgésica",
    "shortTitle": "Hipnosis",
    "description": "Preparación mental para la cirugía, manejo del dolor crónico y autohipnosis para vivir mejor con la artrosis.",
    "icon": "Brain",
  ...
  },
  {
    "id": "chirurgie",
    "slug": "chirurgie",
    "title": "Cirugía, rizartrosis",
    "shortTitle": "Cirugía",
    "description": "Comprender la rizartrosis, las opciones quirúrgicas, las prótesis y la atención postoperatoria.",
    "icon": "Stethoscope",
  ...
  },
  {
    "id": "nutrition",
    "slug": "nutrition",
    "title": "Nutrición antiinflamatoria / micronutrición",
    "shortTitle": "Nutrición",
    "description": "La alimentación, la primera medicina. Alimentos protectores, menús antiinflamatorios y micronutrición específica.",
    "icon": "Apple",
  ...
  },
  {
    "id": "beaute",
    "slug": "beaute",
    "title": "Belleza y medicina estética de las manos",
    "shortTitle": "Belleza",
    "description": "Rejuvenecimiento, cuidados hidratantes, medicina estética y rutinas para cuidar las manos a cualquier edad.",
    "icon": "Sparkles",
  ...
  },
  {
    ...
    "description": "Rehabilitación especializada, protocolos posquirúrgicos, fortalecimiento muscular y consejos para músicos.",
    "icon": "Dumbbell",
...
export const articles: Article[] = [
  {
    ...
    "title": "órtesiss (postoperatorios)",
    "description": "Le rôle et l'importance de l'órtesis dans la récupération après chirurgie.",
    ...
    "videos": [
      {
        ...
        "title": "órtesiss — vidéo 1"
      },
      {
        "embedUrl": "https://www.youtube.com/embed/J3vyX6kWxlA",
        "title": "órtesiss — vidéo 2"
      }
    ],
    "content": "## Qu'est-ce qu'une órtesis ?\n\nUne órtesis est un dispositif médical externe, conçu pour soutenir, immobiliser ou corriger une articulación ou une partie du corps. Dans le cas de l'artrosis de la mano, l'órtesis vise à soulager la douleur, limiter les mouvements douloureux et protéger les articulacións fragilisées.\n\n## Types d'órtesiss pour l'artrosis de la mano\n\nPrivilégier les órtesiss réalisées sur mesure : elles sont adaptées à la morphologie de la main, offrent un ajustement précis et un confort optimal, permettant une meilleure efficacité et un port prolongé.\n\n- **órtesis de reposo longue** : portée principalement la nuit ou lors de phases douloureuses, elle immobilise le poignet et le pouce pour réduire l'inflammation. À porter également lors de moments de repos dans la journée.\n- **órtesis de jour** : plus courte, elle permet de maintenir une bonne posture articulaire tout en laissant la main fonctionnelle. Elle stabilise la base du pouce pour limiter la douleur lors des mouvements de prensión.\n- **órtesis doigt à doigt** : maintien d'un ou plusieurs doigts pour lutter contre la déformation et limiter la douleur. À porter la nuit.\n- **órtesis de actividad** : conçue pour être portée lors de certaines activités spécifiques (travail, loisirs), elle protège l'articulación tout en permettant une mobilité adaptée.\n\n## Comment les órtesiss aident-elles au quotidien ?\n\n- Réduction de la douleur en limitant les mouvements excessifs\n- Protection des articulacións fragiles lors des activités\n- Amélioration de la fonction manuelle grâce à une meilleure stabilité\n- Diminution de la fatigue musculaire\n\n## Conseils pour bien utiliser une órtesis\n\n- Toujours suivre les recommandations de votre professionnel de santé\n- Porter l'órtesis aux moments où la douleur ou la fatigue se manifeste\n- Ne pas forcer sur l'articulación immobilisée\n- Vérifier régulièrement l'état de l'órtesis (usure, ajustement)\n- Associer l'órtesis à des exercices et gestes protecteurs\n\n## Quand consulter un professionnel ?\n\n- Dès l'apparition de douleurs persistantes ou de déformations\n- Pour un bilan personnalisé et le choix de l'órtesis adaptée\n- En cas d'inconfort, de douleur nouvelle ou de problème d'ajustement\n- Pour un suivi régulier et une adaptation en fonction de l'évolution de la maladie",
    "published": true,
    "reviewed": false
  },
  {
    ...
    "description": "Qu'est-ce que l'terapia ocupacional et comment peut-elle vous aider ?",
  ...
  },
  {
    ...
    "poleSlug": "ergotherapie-ortheses",
    "title": "Exercices terapia ocupacional",
  ...
  },
  {
    ...
    "description": "Comment améliorer la qualité de vie professionnelle avec l'artrosis de la mano.",
  ...
  },
  {
    ...
    "poleSlug": "ergotherapie-ortheses",
    "title": "terapia ocupacional et Gestion de la douleur",
    "description": "Comment soulager la douleur grâce à l'terapia ocupacional.",
    ...
    "content": "## Comprendre la douleur liée à l'artrosis\n\nL'artrosis est une maladie dégénérative des articulacións qui provoque une inflammation locale, entraînant des douleurs et une raideur, particulièrement au réveil ou après un effort. La douleur est un signal d'alerte, mais elle peut aussi devenir chronique et limiter la qualité de vie.\n\n## Techniques non médicamenteuses\n\n- **Gestes et postures adaptés** : éviter les mouvements brusques ou répétitifs, utiliser les gestes protecteurs enseignés en terapia ocupacional\n- **Exercices doux** : mobilisations régulières pour maintenir la souplesse articulaire\n- **Thermothérapie** : application de chaleur (bouillotte, bain chaud) pour détendre les muscles et réduire la raideur, ou froid (glace) en cas de poussée inflammatoire\n- **Massages adaptés** : réalisés par un professionnel pour améliorer la circulation et détendre les tissus\n- **Topiques** (crèmes, gels) appliqués localement pour un effet ciblé. Il existe des baumes naturels ayant une action antiinflamatorio.\n- **Relaxation et gestion du stress** : techniques de respiration, méditation ou sophrologie peuvent diminuer la perception de la douleur\n\n## Rôle de l'terapia ocupacional dans la gestion de la douleur\n\n- Enseignement des gestes protecteurs\n- Adaptation des activités quotidiennes pour limiter les contraintes sur les articulacións douloureuses\n- Conseils sur les aides techniques et órtesiss\n- Mise en place d'un programme d'exercices personnalisés\n\n## Quand consulter un professionnel ?\n\n- Si la douleur est persistante, intense ou évolutive\n- En cas de limitations fonctionnelles importantes\n- Pour un bilan et un ajustement du traitement\n- Pour un accompagnement en terapia ocupacional ou en fisioterapia",
    "published": true,
    "reviewed": false
  },
  {
    ...
    "poleSlug": "ergotherapie-ortheses",
    "title": "Matériels d'terapia ocupacional, Soins térébenthine",
  ...
  },
  {
    ...
    "description": "Définition, mécanismes et bienfaits de l'hypnose dans la prise en charge de la douleur et de l'artrosis de la mano.",
  ...
  },
  {
    ...
    "poleSlug": "chirurgie",
    "title": "artrosis del pulgar : causes, évolution et facteurs aggravants",
    "description": "Comprendre pourquoi l'artrosis de la mano apparaît, comment elle évolue et ce qui peut l'aggraver.",
    ...
    "date": "2026-05-18",
    "content": "## Comprendre l'artrosis de la mano et du pouce\n\nL'artrosis de la mano est une maladie chronique des articulacións liée à une usure progressive du cartílago. Le cartílago est un tissu souple qui permet aux os de glisser sans douleur lors des mouvements. Lorsqu'il s'abîme, les articulacións deviennent moins fluides, plus sensibles et peuvent se déformer avec le temps.\n\nL'artrosis peut toucher plusieurs zones de la main :\n- les doigts\n- la base du pouce (rizartrosis)\n- le poignet dans certains cas\n\nLa rizartrosis, qui concerne l'articulación située à la base du pouce, est l'une des formes les plus fréquentes. Le pouce étant essentiel dans la plupart des gestes du quotidien, cette atteinte peut rapidement devenir handicapante.\n\n## Pourquoi l'artrosis apparaît-elle ?\n\nL'artrosis n'a pas une seule cause. Elle résulte souvent de plusieurs facteurs associés.\n\n**L'âge :** Avec le temps, le cartílago perd progressivement en souplesse et en capacité de réparation. Le risque d'artrosis augmente donc naturellement avec l'âge.\n\n**Les mouvements répétés :** Certaines activités professionnelles, sportives ou manuelles sollicitent fortement les articulacións de la main : gestes répétitifs, serrage, pincement, utilisation d'outils vibrants, travail prolongé sur écran ou smartphone. Ces contraintes mécaniques répétées peuvent accélérer l'usure articulaire.\n\n**Les facteurs héréditaires :** Certaines personnes présentent une prédisposition familiale. L'artrosis des doigts est notamment plus fréquente dans certaines familles.\n\n**Les traumatismes :** Une fracture, une entorse, une luxation ou une ancienne blessure de la main ou du pouce peuvent fragiliser une articulación et favoriser l'apparition d'une artrosis secondaire.\n\n**Les hormones :** L'artrosis de la mano touche plus souvent les femmes, notamment après la ménopause, suggérant un rôle hormonal dans son développement.\n\n**L'hyperlaxité et certaines morphologies :** Des articulacións très souples ou certaines formes anatomiques du pouce peuvent entraîner une instabilité favorisant l'usure du cartílago.\n\n## Comment évolue l'artrosis ?\n\nL'artrosis évolue généralement lentement, sur plusieurs années.\n\nAu début, les douleurs apparaissent surtout lors des efforts : ouvrir un bocal, tourner une clé, porter des objets, écrire, utiliser un téléphone.\n\nPuis les symptômes peuvent devenir plus fréquents :\n- douleurs au repos\n- perte de force\n- raideur matinale\n- gêne dans les gestes fins\n- sensation de craquement\n- gonflement articulaire\n\nAvec le temps, certaines articulacións peuvent se déformer. Dans la rizartrosis, le pouce peut perdre en stabilité et en force, rendant certains gestes du quotidien difficiles.\n\nL'évolution est très variable d'une personne à l'autre. Certaines artrosiss restent peu gênantes pendant des années, tandis que d'autres deviennent rapidement invalidantes.\n\n## Les facteurs qui aggravent l'artrosis\n\nCertains éléments peuvent accélérer l'évolution ou augmenter les douleurs :\n\n- les gestes répétitifs excessifs\n- le port de charges lourdes\n- le manque de repos articulaire\n- certaines activités manuelles intensives\n- les mauvaises postures\n- le stress et la fatigue\n- le tabac\n- le surpoids (qui favorise l'inflammation générale)\n- l'absence de prise en charge précoce\n\nDes poussées inflammatoires peuvent également survenir par périodes, provoquant davantage de douleur et de gonflement.\n\n## Peut-on agir ?\n\nOui. Une prise en charge précoce permet souvent de ralentir l'évolution et d'améliorer le confort au quotidien.\n\nLa prévention repose notamment sur :\n\n- l'adaptation des gestes\n- la protection des articulacións\n- les exercices adaptés\n- le maintien de la mobilité\n- une bonne hygiène de vie\n- l'utilisation d'attelles lorsque nécessaire\n- un accompagnement médical personnalisé\n\nMieux comprendre son artrosis permet d'agir plus tôt et de préserver durablement la fonction de la main.",
    "published": true,
    "reviewed": false
  },
  {
    ...
    "poleSlug": "chirurgie",
    "title": "La rizartrosis",
    "description": "Définition, causes, symptômes, diagnostic et traitements de l'artrosis de la base du pouce.",
  ...
  },
  {
    ...
    "description": "Qu'est-ce qu'un chirurgien de la main ? Comment se déroule une intervention de rizartrosis ?",
  ...
  },
  {
    ...
    "poleSlug": "chirurgie",
    "title": "prótesiss trapeciometacarpianas et prótesiss digitales IPP",
    "description": "Tout savoir sur les prótesiss trapeciometacarpianas et digitales IPP",
  ...
  },
  {
    ...
    "poleSlug": "nutrition",
    "title": "Les 10 règles d'OR de l'alimentation antiinflamatorio",
    "description": "Les principes fondamentaux d'une alimentation qui protège vos articulacións au quotidien.",
  ...
  },
  {
    ...
    "poleSlug": "nutrition",
    "title": "La nutrition antiinflamatorio",
    "description": "\"L'alimentation est la première des médecines.\" Comprendre comment l'assiette agit sur l'artrosis.",
  ...
  },
  {
    ...
    "poleSlug": "nutrition",
    "title": "Les Aliments antiinflamatorios",
    "description": "Guide complet des aliments à privilégier pour soutenir vos articulacións et réduire l'inflammation.",
  ...
  },
  {
    ...
    "poleSlug": "nutrition",
    "title": "Petits déjeuners antiinflamatorios",
  ...
  },
  {
    "slug": "idees-menus",
    "poleSlug": "nutrition",
    "title": "Les idées menus antiinflamatorios",
    "description": "Une galerie de menus antiinflamatorios pour s'inspirer au quotidien.",
    ...
    "content": "## Inspiration repas\n\nCes idées menus illustrent comment composer des repas antiinflamatorios variés, gourmands et accessibles.\n\nChaque menu respecte les principes de la nutrition antiinflamatorio : abondance de végétaux colorés, oméga-3 présents, glucides à IG bas, protéines maigres et bonnes graisses.",
    "published": true,
    "reviewed": false
  },
  {
    "slug": "micronutrition",
    "poleSlug": "nutrition",
    "title": "micronutrición",
    "description": "Vitamines, minéraux et oligo-éléments : comment la micronutrición optimise la santé articulaire.",
    ...
    "date": "2024-08-02",
    "content": "## 1. Qu'est-ce que la micronutrición ?\n\nLa micronutrición est une approche de la santé qui se concentre sur les micronutriments — vitamines, minéraux, oligo-éléments, acides gras essentiels, antioxydants, acides aminés, probiotiques…\n\nCes éléments, bien que nécessaires en très petites quantités, jouent un rôle majeur dans le fonctionnement optimal de nos cellules, la protection contre l'inflammation et la régénération tissulaire.\n\nDans le cas de l'artrosis de la mano (et particulièrement la rizartrosis), la micronutrición vise à :\n- Réduire l'inflammation chronique de l'articulación\n- Soutenir la réparation et la souplesse des tissus articulaires\n- Améliorer la lubrification articulaire\n- Limiter la progression de l'usure du cartílago\n\n## 2. Les grands principes appliqués à l'artrosis\n\n- **Principe 1 – Corriger les déficits** : Un manque en vitamine D, magnésium ou oméga-3 peut aggraver l'inflammation et la dégradation articulaire.\n- **Principe 2 – Optimiser les apports protecteurs** : Apporter suffisamment d'antioxydants (vitamines C et E, polyphénols) pour contrer les radicaux libres qui endommagent le cartílago.\n- **Principe 3 – Favoriser l'équilibre global** : Soutenir l'équilibre intestinal (microbiote) qui influence l'inflammation systémique.\n\n## 3. Comment et pourquoi ça fonctionne ?\n\nDans l'artrosis, l'inflammation libère des enzymes destructrices qui dégradent le cartílago. Les micronutriments agissent à différents niveaux :\n\n- **antiinflamatorios naturels** (oméga-3, curcumine) → réduisent la production de cytokines pro-inflammatoires\n- **Antioxydants** (vitamines C, E, sélénium, zinc) → limitent le stress oxydatif qui abîme les cellules articulaires\n- **Cofacteurs enzymatiques** (magnésium, manganèse, cuivre) → nécessaires à la fabrication de collagène et d'élastine, composants clés des articulacións\n- **Probiotiques** → améliorent l'équilibre intestinal, ce qui module la réponse inflammatoire globale\n\n## 4. Conseils pratiques\n\n- Faire un bilan micronutriciónnel avant toute supplémentation pour cibler vos besoins réels\n- Associer les compléments à une alimentation antiinflamatorio (richesse en oméga-3, fibres, végétaux colorés)\n- Fractionner les prises dans la journée pour une meilleure absorption\n- Hydrater régulièrement pour soutenir la fonction articulaire\n\n> **Note importante :** La micronutrición ne remplace pas les traitements médicaux ni la rehabilitación, mais elle optimise l'efficacité de l'ensemble du parcours de soins. Il est important d'en parler avec votre médecin traitant car il peut y avoir des interactions avec certains traitements.",
    "published": true,
    "reviewed": false
  },
  {
  ...
  },
  {
    ...
    "title": "fisioterapia et artrosis de la mano",
    "description": "Objectifs, principes clés et contenu d'une séance type de fisioterapia pour la rizartrosis.",
  ...
  },
  {
    ...
    "poleSlug": "kinesitherapie",
    "title": "La fisioterapia et l'artrosis de la mano",
    ...
    "date": "2025-10-24",
    "content": "## 1. Pourquoi la fisioterapia est utile\n\nL'artrosis de la mano, et plus particulièrement la rizartrosis (base du pouce), entraîne douleur, raideur et perte de force et de fonction. La fisioterapia a pour objectifs :\n\n- Soulager la douleur par des techniques manuelles, de la mobilisation douce et des méthodes physiques (chaleur, physiothérapie…)\n- Préserver ou améliorer la mobilité articulaire, afin de maintenir les gestes du quotidien\n- Renforcer les muscles stabilisateurs pour protéger les articulacións et éviter les compensations néfastes\n- Apprendre des gestes protecteurs et adapter l'environnement pour limiter les contraintes mécaniques\n\nEn intervenant tôt, le fisioterapeuta peut ralentir la perte fonctionnelle, réduire l'inflammation et améliorer la qualité de vie.\n\n## 2. Pourquoi consulter un fisioterapeuta spécialiste de la main\n\nLa main est une structure complexe avec plus de 20 articulacións, un réseau tendineux dense et une mécanique fine. Un fisioterapeuta formé spécifiquement à la rehabilitación de la main possède :\n\n- Une connaissance approfondie de l'anatomie et de la biomécanique de la main et du poignet\n- La maîtrise de techniques spécifiques comme le recentrage trapézo-métacarpien, l'ouverture de la commissure, ou le renforcement ciblé de l'opposant et du 1er interosseux dorsal\n- L'expertise pour choisir et ajuster une órtesis sur mesure en fonction du stade d'artrosis et de l'activité du patient\n- Une expérience dans l'accompagnement des patients opérés (trapézectomie, ligamentoplastie, prótesis…)\n\n## 3. Quelle formation a suivi un kiné spécialiste de la main\n\nAprès le diplôme d'État en fisioterapia (5 ans d'études), le fisioterapeuta peut suivre :\n\n- Un Diplôme Universitaire (DU) ou Interuniversitaire (DIU) de rehabilitación de la main et du membre supérieur\n- Des formations spécialisées validées par le Conseil de l'Ordre des fisioterapeutas\n- Des stages pratiques dans des centres de chirurgie de la main, en lien direct avec des chirurgiens spécialisés\n\n## 4. L'importance de la collaboration chirurgien – fisioterapeuta de la main\n\nDans le cas d'une prótesis trapézo-métacarpienne ou interphalangienne proximale (IPP), la réussite ne dépend pas uniquement de la chirurgie.\n\n- **En pré-opératoire**, le fisioterapeuta prépare la main : il entretient la mobilité, réduit l'inflammation et optimise l'état musculaire pour faciliter la récupération\n- **En postoperatorio**, il suit un protocole validé avec le chirurgien : mobilisation progressive, renforcement, travail fonctionnel et conseils d'adaptation\n- La communication régulière entre le chirurgien et le kiné permet d'ajuster le rythme et l'intensité des exercices selon l'évolution",
    "published": true,
    "reviewed": false
  },
  {
    ...
    "poleSlug": "kinesitherapie",
    "title": "fisioterapia post-chirurgie pour rizartrosis",
    "description": "Protocole de rehabilitación par phases après trapézectomie, ligamentoplastie ou prótesis TM.",
  ...
  },
  {
    ...
    "poleSlug": "kinesitherapie",
    "title": "La rizartrosis et le Musicien",
    "description": "Enjeux spécifiques de la rizartrosis pour les musiciens : contraintes, órtesiss fonctionnelles et solutions chirurgicales.",
    ...
    "date": "2025-10-24",
    "content": "La rizartrosis est une atteinte dégénérative de la base du pouce susceptible de limiter la fonction de la main et a fortiori celle du musicien.\n\nLa colonne du pouce joue un rôle fondamental dans la formation des arches de la main, et l'articulación Trapézo-métacarpienne (TM) est responsable de l'orientation tridimensionnelle du pouce dans l'espace.\n\n## Quels sont les risques pour le musicien atteint de rizartrosis ?\n\n**La douleur** — instabilité douloureuse à la base du pouce lors de la prise de l'instrument, à la mobilisation des tissus périarticulaires. Cette douleur peut être d'apparition spontanée ou provoquée et très variable en intensité.\n\n**La raideur** — peut s'installer insidieusement. Au stade ultime elle peut évoluer vers la fusion articulaire de l'articulación TM. La raideur débute souvent par une limitation de l'opposition ou une fermeture de la 1ère commissure, entravant la mobilité du pouce en opposition ou la réalisation d'écarts.\n\n**La perte de force** — due en premier lieu à la douleur, puis à une amyotrophie de non utilisation. Ceci va se traduire par une diminution progressive de la force d'appui sur la corde ou la touche.\n\n## Les órtesiss fonctionnelles pour les musiciens\n\nIl est possible de réaliser des órtesiss fonctionnelles compatibles avec la pratique instrumentale. Elles permettent de :\n- Limiter les contraintes et la douleur\n- Stabiliser l'articulación\n- Améliorer le comportement musculaire du pouce et son placement\n\nLes techniques de \"taping\" spécifique à la rizartrosis vont aider le musicien pour un concert ou un évènement, avec une efficacité de quelques heures.\n\n## rehabilitación et auto-rehabilitación\n\nLes principes de rehabilitación reposent sur :\n\n- Maintien de l'ouverture de la 1ère commissure\n- Décompression articulaire\n- Renforcement statique des muscles stabilisateurs\n- Éducation à la prise de l'instrument\n- Alternance des rythmes de serrage-relâchement\n- Mise en place d'aides techniques\n- Économie articulaire\n- Développer la mobilité du pouce dans les prises plutôt que l'appui statique longtemps maintenu\n\n**Conseils pratiques :** s'échauffer avant de jouer, traction et chaleur pour soulager, port d'órtesiss nocturnes systématiques, et fonctionnelles si possible, auto-rehabilitación, étude du geste, placement, mobilité et relâchement du pouce.\n\n## La chirurgie de la rizartrosis : une chance pour les musiciens\n\nFruit de plusieurs décennies d'expérimentation des chirurgiens français, les dernières générations de prótesiss trapézo-métacarpiennes offrent aux musiciens atteints de rizartrosis sévère la possibilité de retrouver un pouce indolore, solide et performant en 2 ou 3 mois.\n\nL'expérience du chirurgien de la main est un atout majeur du résultat. L'intervention est aujourd'hui une alternative de qualité plutôt que l'arrêt de l'instrument.",
    "published": true,
    "reviewed": false
  }
];
